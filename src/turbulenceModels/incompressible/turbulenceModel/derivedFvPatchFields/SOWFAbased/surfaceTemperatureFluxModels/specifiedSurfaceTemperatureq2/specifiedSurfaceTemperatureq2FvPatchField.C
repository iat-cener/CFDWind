...
#include "specifiedSurfaceTemperatureq2FvPatchField.H"
...
specifiedSurfaceTemperatureq2FvPatchField::
specifiedSurfaceTemperatureq2FvPatchField
(
    const fvPatch& p,
...
specifiedSurfaceTemperatureq2FvPatchField
(
    const specifiedSurfaceTemperatureq2FvPatchField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
specifiedSurfaceTemperatureq2FvPatchField
(
    const specifiedSurfaceTemperatureq2FvPatchField& wfpf
)
:
...
void specifiedSurfaceTemperatureq2FvPatchField::evaluate
(
...
)
{
    ...
    //ToDo  make it read the z0 field
...
//  const dimensionedScalar& TRefDim = laminarTransport.lookup("TRef");
    ...
    //Info <<"TSurface_="<<TSurface_->value(t)<<endl;
    ...
    forAll(UParallelP, facei)
    {
		...
		//	 << "UParallelP = " << UParallelP[facei] << endl;
...
vector specifiedSurfaceTemperatureq2FvPatchField::transformVectorCartToLocal
(
    vector v, 
    vector xP, 
    vector yP, 
...
vector specifiedSurfaceTemperatureq2FvPatchField::transformVectorLocalToCart
(
    vector vP,
    vector xP,
    vector yP,
...
void  specifiedSurfaceTemperatureq2FvPatchField::qwEvaluate
(
    scalar& qw,
    scalar& uStar, 
    scalar& L, 
...
)
{
          ...
          //Info << "uStar0 = " << uStar0 << endl;
            ...
            // Add definition of thermal roughness  //rchavez
            scalar z0H = z0/100.0;
            ...
            // neutral
            //if (deltaT == 0.0)
            if (mag(deltaT) <= neutralTol)
            {
                //Info << "Neutral qw" << endl;
                qw = qw0;
                uStar = uStar0;
                L = 1.0E30;
                phiM = 1.0;
            ...
            Info << "Iterations for qwall = " << iter << endl;
            
}

void specifiedSurfaceTemperatureq2FvPatchField::write(Ostream& os) const
{
